// <copyright file="SyntaxFacts.cs" company="BitcoderCZ">
...
public static class SyntaxFacts
{
	...
	public static bool IsKeyword(this SyntaxKind kind)
		=> kind.ToString().StartsWith("Keyword", StringComparison.Ordinal);

	public static bool IsModifier(this SyntaxKind kind)
		=> kind.ToString().EndsWith("Modifier", StringComparison.Ordinal);

	public static bool IsToken(this SyntaxKind kind)
		=> !kind.IsTrivia() &&
			   (kind.IsKeyword() || kind.IsModifier() || kind.ToString().EndsWith("Token", StringComparison.Ordinal));
