// <copyright file="BoundNodeFactory.cs" company="BitcoderCZ">
...
internal static class BoundNodeFactory
{
	...
	{
		Debug.Assert(literal is null || literal is string || literal is bool || literal is float || literal is float3 || literal is Rotation, "Literal type must be one of: null, string, bool, float, float3 or Rotation.");
