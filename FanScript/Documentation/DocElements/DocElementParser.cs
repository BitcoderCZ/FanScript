// <copyright file="DocElementParser.cs" company="BitcoderCZ">
...
#pragma warning restore IDE0046
		...
		{
			ConstantGroup? group = Constants.Groups.First(group => value.Text.StartsWith(group.Name, StringComparison.Ordinal));
